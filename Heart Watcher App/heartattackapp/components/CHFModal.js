...
import styles from "../assets/stylesheets/components/CHFModalStyles";
import {
  handleRunPrediction,
  CheckCHFTable,
} from "../services/predictivemodels/CHFPredictiveModels";

const CHFModal = ({ isVisible2, toggleModal }) => {
  ...
  const CheckData = async () => {
    const userId = await AsyncStorage.getItem("userId");
    const isComplete = await CheckCHFTable(userId);
    ...
    >
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          <Text style={styles.modalTitle}>Heart Failure Risk Assessment</Text>
